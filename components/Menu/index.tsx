                ...
                <div className="max-w-screen-xl flex flex-col items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2">
                        <button onClick={toggleNavbar} data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 " aria-controls="navbar-sticky" aria-expanded="false">
                            ...
                            <span className="ml-2 text-xl">Menu</span>
                        </button>
                    </div>
                    <div className={`items-center justify-between ${displayNavBar} w-full md:flex md:w-auto md:order-1`} id="navbar-sticky">
                        <ul className="flex items-center flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
                            <li>
                                <a href="/" className="block py-2 pl-3 pr-4 rounded md:bg-transparent text-xl" aria-current="page">Home</a>
                            </li>
                            <li>
                                <a href="/about" className="block py-2 pl-3 pr-4 rounded md:bg-transparent text-xl">A Empresa</a>
                            </li>
                            <li>
                                <a href="/services" className="block py-2 pl-3 pr-4  rounded md:bg-transparent text-xl">Serviços</a>
                            </li>
                            <li>
                                <a href="/products" className="block py-2 pl-3 pr-4 rounded md:bg-transparent text-xl">Produtos</a>
                            </li>
                            <li>
                                <a href="/partners" className="block py-2 pl-3 pr-4  rounded md:bg-transparent text-xl">Parceiros</a>
                            </li>
                            <li>
                                <a href="/news" className="block py-2 pl-3 pr-4 rounded md:bg-transparent text-xl">Notícias</a>
                            </li>
                            <li>
                                <a href="/contact" className="block py-2 pl-3 pr-4 rounded md:bg-transparent text-xl">Fale Conosco</a>
                            </li>
                        </ul>
                    </div>
                </div>
